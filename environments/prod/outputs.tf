...
output "mysql_server_fqdn" {
  description = "MySQL Server FQDN (HA, geo-redundant)"
...
output "storage_account_name" {
  description = "Storage Account Name (RAGRS replication)"
...
output "production_summary" {
  ...
  value = {
    aks_ha_nodes = "3+ nodes across availability zones"
    aks_auto_scaling = "Enabled, max 10 nodes"
    mysql_sku = "Memory-optimized with 30-day backup and geo-redundancy"
    app_service_tier = "P1v2 Premium"
    function_app_tier = "P1v2 Premium"
    storage_replication = "RAGRS (Read-access geo-redundant)"
    acr_sku = "Premium"
...
output "application_gateway_id" {
  description = "Application Gateway ID (HA Configuration)"
...
output "domain_configuration_summary" {
  ...
  value = {
    ...
    high_availability  = "Multi-zone, auto-scaling, geo-redundant"
  }
}
