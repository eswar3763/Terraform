...
variable "app_service_plan_name" {
  ...
  type        = string
  default     = "asp-3tier-dev"
}

variable "app_service_name" {
  description = "App Service name"
  type        = string
  default     = "app-3tier-dev"
}
